...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/eVq0qsYodV)
...
```sh
npx nx serve supertic
```

To create a production bundle:

```sh
npx nx build supertic
```

To see all available targets to run for a project, run:

```sh
npx nx show project supertic
```
